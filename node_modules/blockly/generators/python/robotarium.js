...
while (np.size(at_pose(x, target_values, rotation_error=100)) != N):
 ...
 Blockly.Python['display_image'] = function(block) {
  var value_image_name = Blockly.Python.valueToCode(block, 'image name', Blockly.Python.ORDER_ATOMIC);
...
gt_img_handle = r.axes.imshow(gt_img, extent=(-1, 1, -1, 1))
 ...
 Blockly.Python['move_foreward'] = function(block) {
...
Blockly.Python['turn_counterclockwise'] = function(block) {
