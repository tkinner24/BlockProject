...
Blockly.Python['wait'] = function(block) {
  ...
  var code = `Add_Target_Point(curName,robotList[namesList.index(curName)].target_Array[-1][0],robotList[namesList.index(curName)].target_Array[-1][1],0,-2, message)\n`;
  return code;
};
...
Blockly.Python['send_message'] = function(block) {
  var value_message = block.getFieldValue(block, 'message', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
var code = `np.append(messageList, ["`+value_message+`",False], axis=1)
...
Blockly.Python['wait_until_message'] = function(block) {
  var value_message = block.getFieldValue(block, 'message', Blockly.Python.ORDER_ATOMIC);
  // TODO: Assemble Python into code variable.
  var code = 'message = messageList.index("'+value_message+'")\n';
  return code;
};