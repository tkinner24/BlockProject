...
Add_Target_Point(curName,robotList[namesList.index(curName)].target_points[-1][0],robotList[namesList.index(curName)].target_points[-1][1],robotList[namesList.index(curName)].target_points[-1][2] *180/3.14,drawing, message) \n` ;
  return code;
};
