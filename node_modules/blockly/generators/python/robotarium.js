...
class Robot:
    ...
    def moveForward(self, distance):
        curX = self.target_points[self.totalPoints-1][0]
        curY = self.target_points[self.totalPoints-1][1]
        curT = self.target_points[self.totalPoints-1][2]
...
Blockly.Python['move_forward'] = function(block) {
  ...
  var code = `
robotList[namesList.index("`+text_name+`")].moveForward(`+number_distance+`)
`;
  return code;
};