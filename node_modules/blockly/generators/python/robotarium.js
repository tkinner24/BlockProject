...
`;
 ...
 Blockly.Python['run_to_point'] = function(block) {
   ...
   var code = `
Add_Target_Point(curName,`+number_target_x+`,`+number_target_y+`,`+angle+`,drawing)
`;
   return code;
 };
...
Blockly.Python['run_to_point_and_angle'] = function(block) {
  ...
  var code =`
Add_Target_Point(curName,`+number_target_x+`,`+number_target_y+`,`+angle_angle+`,drawing)
`;
  return code;
};
...
Blockly.Python['move_forward'] = function(block) {
  ...
  var code = `
robotList[namesList.index(curName)].move_Forward(`+number_distance+`,drawing)
`;
  return code;
};
